...
//==========================================================================================
// build.h
// Build Information, automatically generated on 04/25/13 09:04:04.  
...
const char  device_id_string[] = "UCD3100ISO1" "|" "0" "." "0" "." "8" "." "0" "317" "|" "150626T3";
...
int pmbus_read_device_id(void)
{
	...
	{
	  pmbus_buffer[byte+1] = (Uint8)device_id_string[byte];
	} 
