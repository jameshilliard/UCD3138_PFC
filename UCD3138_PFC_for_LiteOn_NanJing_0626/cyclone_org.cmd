...
MEMORY
{
    ...
    /* D-Flash   2K    0x18800 - 0x18FFF                                                  */
    /*------------------------------------------------------------------------------------*/
    DFLASH		(RX) : org = 0x00018800, len = 0x00000400

    DFLASH_CAL	(RX) : org = 0x00018C00, len = 0x00000020	/*20141205--Kevin.Lai		  */
...
SECTIONS
{
    ...
    /*------------------------------------------------------------------------------------*/
	 ...
	 .CONFIG_A		: {} > (DFLASH align(32))			/*PFC configuration				  */		
 	 ...
 	 .LITEON_CAL	: {} > (DFLASH_CAL align(32))		/*20141205--Kevin.Lai			  */
